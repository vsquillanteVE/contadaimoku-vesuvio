...
router.post('/test-log', async (req, res) => {
    try {
        ...
        const result = await pool.query(`INSERT INTO daimoku_log
      (amount, hours, minutes, total_minutes, client_info, status)
      VALUES ($1, $2, $3, $4, $5, $6)
      RETURNING id`, [amount, hours, minutes, amount, clientInfo, 'test']);
...
router.post('/debug-daimoku-log', async (req, res) => {
    ...
    `);
      ...
      (amount, hours, minutes, total_minutes, client_info, status)
      VALUES ($1, $2, $3, $4, $5, $6)
      RETURNING id`, [amount, hours, minutes, amount, clientInfo, 'debug-test']);
